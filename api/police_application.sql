CREATE DATABASE  IF NOT EXISTS `police_application` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `police_application`;
-- MySQL dump 10.13  Distrib 8.0.46, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: police_application
-- ------------------------------------------------------
...
CREATE TABLE `employees` (
  ...
  `role` enum('officer','commander') DEFAULT 'officer',
...
-- Dump completed on 2026-08-21 16:33:15
