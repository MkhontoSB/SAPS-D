...
$recent = [];
$recentSql = "
    SELECT 'Case' AS type, case_id AS id, status, CAST(date_reported AS DATETIME) AS activity_date
    FROM cases
    UNION ALL
    SELECT 'Protection Order' AS type, order_id AS id, status, CAST(date_filed AS DATETIME) AS activity_date
...
<div class="container">
    ...
    <div class="quick-actions">
        ...
        <a href="protection_order_overview.php" class="action-card"><h3>Protection Orders</h3><p>Manage protection orders</p></a>
        <a href="protection_orders.php" class="action-card"><h3>File New Order</h3><p>Create protection order</p></a>
    </div>
        ...
        <?php if (!empty($recent)): ?>
            <?php foreach ($recent as $item): ?>
                <div class="activity-item">
                    ...
                    <span><?= htmlspecialchars(time_ago($item['activity_date'])) ?></span>
                </div>
            <?php endforeach; ?>
        <?php else: ?>
