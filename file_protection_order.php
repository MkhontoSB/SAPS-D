...
// Fetch available case IDs from the cases table
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO protection_orders 
        (case_id, reporter_fullname, reporter_id_number, reporter_contact, reporter_address, type_of_abuse, date_of_incident, description, perpetrator_name, immediate_danger) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    
    $stmt->bind_param("isssssssss", $case_id, $reporter_fullname, $reporter_id_number, $reporter_contact, $reporter_address, $type_of_abuse, $date_of_incident, $description, $perpetrator_name, $immediate_danger);
