...
$search = $_GET['search'] ?? '';
$sql = "SELECT case_id, crime_type, description FROM cases WHERE status='Ongoing'";
if ($search) {
...
<div class="container">
    ...
    <ul style="list-style:none; padding:0;">
        <?php while($row = $result->fetch_assoc()): ?>
            <li><a href="ongoing_case_view.php?id=<?= $row['case_id'] ?>">Case #<?= $row['case_id'] ?></a></li>
        <?php endwhile; ?>
    </ul>
